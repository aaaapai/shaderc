...
LOCAL_CFLAGS += -DANDROID -pipe -integrated-as -fno-plt -Ofast -flto=auto -mllvm -polly -mllvm -polly-vectorizer=stripmine -mllvm -polly-invariant-load-hoisting -mllvm -polly-run-inliner -mllvm -polly-run-dce
